...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             //   for (DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                    ...
                    mMap.addMarker(new MarkerOptions().position(car).title(dataSnapshot.getKey()));
              //  }
    ...
    private BitmapDescriptor bitmapDescriptorFromVector(Context context, @DrawableRes int vectorDrawableResourceId) {
        Drawable background = ContextCompat.getDrawable(context, R.drawable.path111);
        background.setBounds(0, 0, background.getIntrinsicWidth(), background.getIntrinsicHeight());
        Drawable vectorDrawable = ContextCompat.getDrawable(context, vectorDrawableResourceId);
        vectorDrawable.setBounds(5, 10, vectorDrawable.getIntrinsicWidth() + 20, vectorDrawable.getIntrinsicHeight() + 20);
